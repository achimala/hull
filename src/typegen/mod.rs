    ...
    F: Fn(&Path, &HashMap<String, String>) -> Result<HashMap<String, TypeExpr>>,
{
    ...
    let mut rust_generator = RustGenerator::new(&named_types, rust_name_map.clone(), rust_args);
    ...
    let rust_api_defs = convex_function_defs
        ...
        .collect::<Result<Vec<_>>>()?;
    let rust_api = generate_rust_api(&rust_api_defs)?;
...
fn function_args_type_name(module: &str, name: &str) -> String {
    pascal_case(&format!("{}_{}_args", module, name))
}

fn function_return_type_name(module: &str, name: &str) -> String {
...
impl RustGenerator {
    ...
    fn generate(&mut self) -> Result<String> {
        ...
        out.push_str("use crate::convex::ConvexValue;\n\n");
...
fn swift_field_name(field: &str) -> String {
...
fn swift_member_name(field: &str) -> (String, Option<String>) {
...
fn swift_case_name(literal: &str) -> String {
...
fn literal_literal(literal: &str, is_number: bool) -> String {
    if is_number {
        literal.to_string()
    } else {
        format!("\"{}\"", literal)
...
fn rust_field_name(field: &str) -> (String, Option<String>) {
    let mut out = String::new();
...
fn rust_variant_name(literal: &str) -> String {
...
fn rust_fn_name(field: &str) -> String {
    let mut out = String::new();
    let mut upper = false;
